...
1. **TDD**: create the project using the test driven development approach and practice  jest.
...
2. **git**: practice better git control habits for a clearer history and version control.
...
3. **algorthima**: practicing  making writing functions that are as efficient as possible.
